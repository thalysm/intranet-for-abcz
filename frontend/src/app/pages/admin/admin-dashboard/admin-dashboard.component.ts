...
export class AdminDashboardComponent {
  ...
  private initCommunicationCharts() {
    ...
    this.commLineChart = {
      series: [
        {
          name: "Enviado",
          data: [25, 30, 28, 35, 40, 38, 42, 45, 30, 25, 35, 40, 38, 42, 45],
        },
        {
          name: "Lido",
          data: [20, 25, 22, 28, 32, 30, 35, 38, 25, 20, 28, 32, 30, 35, 38],
        },
        {
          name: "Clicado",
          data: [10, 12, 15, 18, 20, 18, 22, 25, 15, 10, 18, 20, 18, 22, 25],
        },
      ],
  ...
  private initLoansCharts() {
    ...
    this.loansFunnelChart = {
      ...
      xaxis: {
        categories: ["Simulações", "Análises", "Aprovadas", "Reprovadas"],
      },
    ...
    this.loansBarChart = {
      ...
      title: {
        text: "Aprovadas vs Reprovadas - Últimos 10 Dias",
        align: "left",
      },
      xaxis: {
        categories: [
    ...
    this.loansLineChart = {
      series: [
        {
          name: "Simulações",
          data: [12, 15, 10, 18, 14, 20, 16, 22, 18, 25, 20, 28, 24, 30, 28],
        },
        {
          name: "Análises",
          data: [10, 12, 8, 15, 12, 18, 14, 20, 16, 22, 18, 25, 22, 28, 26],
        },
        {
          name: "Aprovadas",
          data: [8, 10, 6, 12, 10, 15, 12, 18, 14, 20, 16, 22, 20, 25, 24],
        },
      ],
      chart: { type: "line", height: 350, toolbar: { show: false } },
      stroke: { curve: "smooth", width: 3 },
    ...
    this.loansAreaChart = {
      series: [
        ...
        {
          name: "Reprovadas",
          data: [2, 3, 2, 4, 2, 3, 2, 2, 2, 3, 2, 4, 2, 3, 2],
        },
      ],
  ...
  private initBenefitsCharts() {
    ...
    this.benefitsLineChart = {
      series: [
        {
          name: "Solicitadas",
          data: [15, 18, 12, 20, 16, 22, 18, 25, 20, 28, 22, 30, 26, 32, 30],
        },
        {
          name: "Concedidas",
          data: [12, 15, 10, 16, 14, 18, 15, 20, 16, 22, 18, 25, 22, 28, 26],
        },
        {
          name: "Negadas",
          data: [3, 3, 2, 4, 2, 4, 3, 5, 4, 6, 4, 5, 4, 4, 4],
        },
      ],
      chart: { type: "line", height: 350, toolbar: { show: false } },
      stroke: { curve: "smooth", width: 3 },
